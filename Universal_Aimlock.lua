	local Mensaje = game:GetService("StarterGui")
	Mensaje:SetCore("SendNotification",{
		Title = "Potato Gui",
		Text = "Iniciando AimLock",
		Duration = 3
	})
	...
	Move.Name = "Move"
	Move.Parent = Gui
	Move.BackgroundColor3 = Color3.new(255,255,255)
	Move.BackgroundTransparency = 0
	Move.BorderSizePixel = 0
	Move.Position = UDim2.new(0.005, 0,0.018, 0)
	Move.Size = UDim2.new(0.28141585, 0, 0.0320388414, 0)
	Move.BorderColor3 = Color3.fromRGB(255,255,255)

	Main.Name = "Main"
	Main.Parent = Move
	Main.BackgroundColor3 = Color3.new(0.298039,0.298039, 0.298039)
	Main.BackgroundTransparency = 0.6
	Main.Position = UDim2.new(0, 0, 0.995, 0)
	Main.Size = UDim2.new(1,6, 0, 9.79, 0)
	...
	EspStatus.Font = Enum.Font.Oswald
